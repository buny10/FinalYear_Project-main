  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", background: C.bg, fontFamily: "'DM Sans', sans-serif" }}>
      ...
      >
        ...
        <div style={{ flex: 1 }}>
          <h2 style={{ fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: "2.2rem", color: "#fff", lineHeight: 1.2, letterSpacing: "-1px", marginBottom: 18 }}>Join thousands of businesses.</h2>
          <p style={{ color: "#666", lineHeight: 1.8, fontSize: "0.9rem", marginBottom: 48 }}>Set up your account in under 2 minutes and take control of your business.</p>
      ...
      <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: 40 }}>
        <div style={{ width: "100%", maxWidth: 420, animation: "fadeSlide 0.4s ease forwards" }}>
          <h2 style={{ fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: "1.8rem", marginBottom: 4, letterSpacing: "-0.5px" }}>{step === 1 ? "Business Details" : "Account Setup"}</h2>
          <p style={{ color: C.textMuted, marginBottom: 28, fontSize: "0.88rem" }}>{step === 1 ? "Tell us about your organization" : "Set up your login credentials"}</p>
          ...
          {step === 1 ? (
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              <Input label="Company" value={form.company} onChange={v => setForm({ ...form, company: v })} placeholder="Nihareeka Canteen" error={errors.company}/>
              <Select 
                label="Your Role" 
                value={form.role} 
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              <label style={{ display: "flex", gap: 9, alignItems: "center", cursor: "pointer" }}>
                ...
                />
                <span style={{ fontSize: "0.82rem", color: C.textMuted }}>I agree to <a href="#" style={{ color: C.accent }} onClick={e => e.preventDefault()}>Terms</a> & <a href="#" style={{ color: C.accent }} onClick={e => e.preventDefault()}>Privacy Policy</a></span>
              </label>
