  ...
  return (
    <div className="page-content" style={{ padding: "28px 28px", overflowY: "auto", flex: 1, display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 16, marginBottom: 24 }}>
        ...
        <StatCard label="Total Expenses (YTD)" value={fmt(totalExpenses)} change="-3.2%" icon="dashboard" color={C.danger} />
        <StatCard label="Net Profit (YTD)" value={fmt(netProfit)} change="+15.8%" icon="finance" color={C.info} />
        <StatCard label="Pending Invoices" value={fmt(pendingInvoicesAmt)} change="-2.1%" icon="dollar" color={C.warning} />
      </div>
